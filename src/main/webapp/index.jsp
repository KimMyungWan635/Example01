                ...
                <div class="row align-items-center justify-content-start">
                    <div class="col-lg-10 col-md-10">
                        <div class="slider_text">
                            ...
                            <a class="boxed-btn3 wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="./studyview1.do">강의 보기 1</a>
                            <a class="boxed-btn3 wow fadeInLeft"  data-wow-duration="1s" data-wow-delay=".2s" href="./studyview11.do">강의 보기 1-1</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="about_info">
                        <div class="section_title white_text">
                            ...
                            <p class="last_text wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">âFunction information without cross action media value.</p>
                ...
                <div class="col-lg-5">
                    <div class="work_info">
                        <div class="section_title">
                            ...
                            <p class="mid_text wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">âFunction information without cross action media value.</p>
